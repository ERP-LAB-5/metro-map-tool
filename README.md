...
**v3.6.1** · GPL-3.0 · [releases](https://github.com/ERP-LAB-5/metro-map-tool/releases)
...
```bash
curl -L https://github.com/ERP-LAB-5/metro-map-tool/archive/refs/tags/v3.6.1.tar.gz | tar xz
cd metro-map-tool-3.6.1
...
```bash
pipx install git+https://github.com/ERP-LAB-5/metro-map-tool@v3.6.1
...
pip install --upgrade git+https://github.com/ERP-LAB-5/metro-map-tool@v3.6.1
...
`--upgrade` on its own will not move you if you pinned a tag: `@v3.6.1` means
...
```bash
pipx install --force git+https://github.com/ERP-LAB-5/metro-map-tool@v3.6.1
```
